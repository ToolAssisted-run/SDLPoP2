...
void hook_desert_gate(int8_t tilepos); void hook_desert_wave(int8_t tilepos); void hook_desert_tile1e(void); void hook_desert_press(int col); void hook_pal_rotate(int start, int count); void hook_pal_load(int sub, int count, int start, int res); void hook_pal_restore(void);   /* the drawing's parts of tick code (weak no-ops; shell.c: the renderer) */
