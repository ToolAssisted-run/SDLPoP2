...
here=$(cd "$(dirname "$0")" && pwd); W=${WORK:-$WS/work}; O=$WS/oracle; S=$WS/sources/prince2
...
# keyboard -> controls (capture $POP2_WORKSPACE/oracle/keyprobe.script: every movement key, shifts, ctrl, alt)
