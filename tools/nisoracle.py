...
Shots go to $POP2_WORKSPACE/oracle/w_nis/NAME/sFRAME.tga; probes log the anim frames, fades, music/sound starts and MIDI cues
with the game's 60 Hz tick (DS:24E4).  Run: $POP2_WORKSPACE/oracle/cap.sh NAME "prince yippeeyahoo NIS21" """
import sys, os
...
O = WS + '/oracle'; W = '%s/w_nis/%s' % (O, name); os.makedirs(W, exist_ok=True)
