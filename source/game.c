...
int frame_end(void)
{
	...
	else { hook_draw(0); draw_mobs_state(); kid_sprite_state(); draw_chars_state(); lever5_draw_state(); if (word_5d38) { if (word_5d38 == 1) toggle_upside_down(); else if (Kid.alive < 0) word_5d38--; } }
