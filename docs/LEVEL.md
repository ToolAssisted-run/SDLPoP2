...
| 4374 | 0x17BC | roomlinks[room][4] = left, right, up, down room numbers (room 0 included; used by find_room_of_tile 0AFF:000C) |
| 43E8 | 0x1830 | level header: 43F8 room count (19 in level 1), 43FD level byte (footstep sounds off when 1), 43FF level number, 4418 start room, 4419 start tile (col + 10*row), 441A start direction (prince faces ~dir), 441E level type |
