...
#define K(p) key_table[(p) - 0x1D00]
/* 0823:1178 */
static void read_keyboard(void)
{
	if (bios_shift_flags & 8) return;   /* Alt held: nothing */
	if (K(0x1D55) || K(0x1D24) || K(0x1D1F) || K(0x1D54) || K(0x1D23) || K(0x1D1E) || K(0x1D56) || K(0x1D25) || K(0x1D20)) control_y = -1;
	else if (K(0x1D5D) || K(0x1D32) || K(0x1D2D) || K(0x1D59) || K(0x1D40) || K(0x1D3B) || K(0x1D5C) || K(0x1D3F) || K(0x1D3A)
	         || K(0x1D5E) || K(0x1D41) || K(0x1D3C)) control_y = 1;
	if (K(0x1D58) || K(0x1D31) || K(0x1D2C) || K(0x1D54) || K(0x1D23) || K(0x1D1E) || K(0x1D5C) || K(0x1D3F) || K(0x1D3A)) control_x = -1;
	else if (K(0x1D5A) || K(0x1D33) || K(0x1D2E) || K(0x1D56) || K(0x1D25) || K(0x1D20) || K(0x1D5E) || K(0x1D41) || K(0x1D3C)) control_x = 1;
	bios_shift_flags &= 0xF;
	if ((bios_shift_flags & 3) || K(0x1D60)) control_shift = -1;
	else if ((bios_shift_flags & 4) || K(0x1D5F)) control_shift = -2;
}
