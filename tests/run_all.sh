...
for s in L3loose7 L3loose22 L3btn10 L3btn3 L3r1 L3r2 L3skel1 L3skel2 L3skel3 L3sk11_1 L3sk11_2 L3sk17_1 L3sk20_1; do [ -f $W/$mode$s.bin ] && echo "L3 $s $($W/snaptest $mode $S/SEQUENCE.DAT $O/w/ramL3.bin $S/PRINCE.EXE $W/$mode$s.bin 2>/dev/null | tail -1)"; done
