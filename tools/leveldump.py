...
import struct, sys
TILES=0x0000; ATTRS=0x0348; HDR=0x17F3; ROOMS=0x1867; NROOMS_MAX=28
...
def load(path):
    ...
    for r in range(1,lvl["nrooms"]+1):
        ...
        rooms[r]=dict(tiles=t,attrs=a,nchars=rec[0],chars=chars)
    return lvl,rooms
if __name__=="__main__":
    ...
    for r in want:
        R=rooms[r]; print("room %d (%d chars)"%(r,R["nchars"]))
