 ...
 * quicksave, quickload, restart level, settings, restart game, quit) and the settings screen (general, gameplay,
...
enum { OVERLAY_MENU_NONE, OVERLAY_MENU_QUICKSAVE, OVERLAY_MENU_QUICKLOAD, OVERLAY_MENU_RESTART_LEVEL,
       OVERLAY_MENU_RESTART_GAME, OVERLAY_MENU_QUIT, OVERLAY_MENU_KEY };
 ...
 * closed the menu, for the game (SDLPoP passes its Ctrl+ keys on). The menu may have closed (overlay_menu_is_open) */
int  overlay_menu_frame(SDL_Scancode *key, uint16_t *mod);
/* (tests) the page (0 the pause menu, 1 the settings), the item under the cursor, the settings page shown ("GENERAL",
